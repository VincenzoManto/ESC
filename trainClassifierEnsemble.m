function [trainedClassifier, validationAccuracy] = trainClassifierEnsemble(trainingData, responseData, features)
...
% Auto-generated by MATLAB on 26-Apr-2021 07:48:00
...
subspaceDimension = max(1, min(200, width(predictors) - 1));
...
% Train a classifier
% This code specifies all the classifier options and trains the classifier.
subspaceDimension = max(1, min(200, width(trainingPredictors) - 1));
classificationEnsemble = fitcensemble(...
    trainingPredictors, ...
    trainingResponse, ...
    'Method', 'Subspace', ...
